  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        ...
        <Text style={styles.ocupacao}> Desenvolvedor Java </Text>
        ...
        <Text style={styles.textoDetalhe}>Localização: João Pessoa - Paraíba</Text>
        <Text style={styles.textoDetalhe}>Email: john@doe.com</Text>
        <Text style={styles.textoDetalhe}>Hobbies: Jogar Bola</Text>
    </View>)}
